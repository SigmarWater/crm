...
import (
	...
	customerV1API "github.com/SigmarWater/crm/customer/internal/api/crm/v1"
	"github.com/SigmarWater/crm/customer/internal/interceptor"
	"github.com/SigmarWater/crm/customer/internal/migrator"
	customerRepository "github.com/SigmarWater/crm/customer/internal/repository/customer"
	customerService "github.com/SigmarWater/crm/customer/internal/service/customer"
...
func main() {
	...
	repo := customerRepository.NewRepository(pool)
	service := customerService.NewCustomerService(repo)
	api := customerV1API.NewAPI(service)
	...
	customer_service.RegisterCustomerServiceServer(server, api)
	...
	if err := customer_service.RegisterCustomerServiceHandlerFromEndpoint(
		ctx,
		mux,
	...
	// OpenAPI JSON
	fileServer := http.FileServer(http.Dir("shared/docs/openapi"))
